...
|---|---:|---:|---:|---:|---:|---:|---:|
| `baseline_current` | `0.9470` | `0.8718` | `1.0000` | `0.9315` | `100.00%` | `100.00%` | `+0.0000` |
| `strict_precision` | `0.9470` | `0.8718` | `1.0000` | `0.9315` | `100.00%` | `100.00%` | `+0.0000` |
| `balanced_focus` | `0.9470` | `0.8718` | `1.0000` | `0.9315` | `100.00%` | `100.00%` | `+0.0000` |
| `coverage_plus` | `0.9470` | `0.8718` | `1.0000` | `0.9315` | `100.00%` | `100.00%` | `+0.0000` |
