...
export const REPORT_TYPE_OPTIONS = [
  ...
  },
  {
    ...
    label: "Отчет государственной экспертизы по проверке достоверности сметной стоимости согласно ПП 87",
    defaultTitle: "Отчет государственной экспертизы по проверке достоверности сметной стоимости согласно ПП 87",
  },
] as const;
